   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "9                        NaN        10         159  \n",
       "..                       ...       ...         ...  \n",
       "751                   S Ravi     11347         144  \n",
       "752                Ian Gould     11412         137  \n",
       "753                      NaN     11413         172  \n",
       "754  Chettithody Shamshuddin     11414         156  \n",
       "755              Nigel Llong     11415         153  \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>152059 rows × 24 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "        match_id       city               winner  total_runs_x  inning  \\\n",
       "0              1  Hyderabad  Sunrisers Hyderabad           208       1   \n",
       "1              1  Hyderabad  Sunrisers Hyderabad           208       1   \n",
       "2              1  Hyderabad  Sunrisers Hyderabad           208       1   \n",
       "3              1  Hyderabad  Sunrisers Hyderabad           208       1   \n",
       "4              1  Hyderabad  Sunrisers Hyderabad           208       1   \n",
       "...          ...        ...                  ...           ...     ...   \n",
       "152054     11415  Hyderabad       Mumbai Indians           153       2   \n",
       "152055     11415  Hyderabad       Mumbai Indians           153       2   \n",
       "152056     11415  Hyderabad       Mumbai Indians           153       2   \n",
       "152057     11415  Hyderabad       Mumbai Indians           153       2   \n",
       "152058     11415  Hyderabad       Mumbai Indians           153       2   \n",
       "\n",
       ...
       "...                     ...                          ...   ...   ...   \n",
       "152054  Chennai Super Kings               Mumbai Indians    20     2   \n",
       "152055  Chennai Super Kings               Mumbai Indians    20     3   \n",
       "152056  Chennai Super Kings               Mumbai Indians    20     4   \n",
       "152057  Chennai Super Kings               Mumbai Indians    20     5   \n",
       "152058  Chennai Super Kings               Mumbai Indians    20     6   \n",
       "\n",
       ...
       "4       DA Warner  ...        0           0            0             0   \n",
       "...           ...  ...      ...         ...          ...           ...   \n",
       "152054  RA Jadeja  ...        0           0            0             0   \n",
       "152055  SR Watson  ...        0           0            0             0   \n",
       "152056  SR Watson  ...        0           0            0             0   \n",
       "152057  SN Thakur  ...        0           0            0             0   \n",
       "152058  SN Thakur  ...        0           0            0             0   \n",
       "\n",
       ...
       "152054             1           0             1               NaN   \n",
       "152055             2           0             2               NaN   \n",
       "152056             1           0             1         SR Watson   \n",
       "152057             2           0             2               NaN   \n",
       "152058             0           0             0         SN Thakur   \n",
       "\n",
       ...
       "152054             NaN        NaN  \n",
       "152055             NaN        NaN  \n",
       "152056         run out  KH Pandya  \n",
       "152057             NaN        NaN  \n",
       "152058             lbw        NaN  \n",
       "\n",
       "[152059 rows x 24 columns]"
      ]
     },
     "execution_count": 19,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "152058          Chennai Super Kings       Mumbai Indians    20     6   \n",
       "\n",
       "              batsman  ... legbye_runs noball_runs  penalty_runs  \\\n",
       "125          CH Gayle  ...           0           0             0   \n",
       "126     Mandeep Singh  ...           0           0             0   \n",
       "127     Mandeep Singh  ...           0           0             0   \n",
       "128     Mandeep Singh  ...           0           0             0   \n",
       "129     Mandeep Singh  ...           0           0             0   \n",
       "...               ...  ...         ...         ...           ...   \n",
       "152054      RA Jadeja  ...           0           0             0   \n",
       "152055      SR Watson  ...           0           0             0   \n",
       "152056      SR Watson  ...           0           0             0   \n",
       "152057      SN Thakur  ...           0           0             0   \n",
       "152058      SN Thakur  ...           0           0             0   \n",
       "\n",
       "        batsman_runs  extra_runs  total_runs_y  player_dismissed  \\\n",
       "125                1           0             1               NaN   \n",
       "126                0           0             0               NaN   \n",
       ...
       "152058             0           0             0         SN Thakur   \n",
       "\n",
       "        dismissal_kind    fielder  current_Score  \n",
       "125                NaN        NaN              1  \n",
       "126                NaN        NaN              1  \n",
       "127                NaN        NaN              1  \n",
       "128                NaN        NaN              3  \n",
       ...
       "152054             NaN        NaN            152  \n",
       "152055             NaN        NaN            154  \n",
       "152056         run out  KH Pandya            155  \n",
       "152057             NaN        NaN            157  \n",
       "152058             lbw        NaN            157  \n",
       "\n",
       "[73304 rows x 25 columns]"
      ]
     },
     "execution_count": 23,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...               ...  ...         ...          ...           ...         ...   \n",
       "152054      RA Jadeja  ...           0            0             1           0   \n",
       "152055      SR Watson  ...           0            0             2           0   \n",
       "152056      SR Watson  ...           0            0             1           0   \n",
       "152057      SN Thakur  ...           0            0             2           0   \n",
       "152058      SN Thakur  ...           0            0             0           0   \n",
       "\n",
       ...
       "129                4               NaN             NaN        NaN   \n",
       "...              ...               ...             ...        ...   \n",
       "152054             1               NaN             NaN        NaN   \n",
       "152055             2               NaN             NaN        NaN   \n",
       "152056             1         SR Watson         run out  KH Pandya   \n",
       "152057             2               NaN             NaN        NaN   \n",
       "152058             0         SN Thakur             lbw        NaN   \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...               ...  ...          ...          ...         ...   \n",
       "152054      RA Jadeja  ...            0            1           0   \n",
       "152055      SR Watson  ...            0            2           0   \n",
       "152056      SR Watson  ...            0            1           0   \n",
       "152057      SN Thakur  ...            0            2           0   \n",
       "152058      SN Thakur  ...            0            0           0   \n",
       "\n",
       "        total_runs_y  player_dismissed  dismissal_kind    fielder  \\\n",
       "125                1               NaN             NaN        NaN   \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...               ...  ...          ...        ...           ...   \n",
       "152054      RA Jadeja  ...            1          0             1   \n",
       "152055      SR Watson  ...            2          0             2   \n",
       "152056      SR Watson  ...            1          0             1   \n",
       "152057      SN Thakur  ...            2          0             2   \n",
       "152058      SN Thakur  ...            0          0             0   \n",
       "\n",
       ...
       "129                    0             NaN        NaN              7        201   \n",
       "...                  ...             ...        ...            ...        ...   \n",
       "152054                 0             NaN        NaN            152          1   \n",
       "152055                 0             NaN        NaN            154         -1   \n",
       "152056                 1         run out  KH Pandya            155         -2   \n",
       "152057                 0             NaN        NaN            157         -4   \n",
       "152058                 1             lbw        NaN            157         -4   \n",
       "\n",
       "        balls_left  wickets_remaining  \n",
       "125            119                 10  \n",
       "126            118                 10  \n",
       "127            117                 10  \n",
       "128            116                 10  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "152054      RA Jadeja  ...          0            1                 0   \n",
       "152055      SR Watson  ...          0            2                 0   \n",
       "152056      SR Watson  ...          0            1                 1   \n",
       "152057      SN Thakur  ...          0            2                 0   \n",
       "152058      SN Thakur  ...          0            0                 1   \n",
       "\n",
       "        dismissal_kind    fielder  current_Score  runs_left  balls_left  \\\n",
       "125                NaN        NaN              1        207         119   \n",
       "126                NaN        NaN              1        207         118   \n",
       "127                NaN        NaN              1        207         117   \n",
       "128                NaN        NaN              3        205         116   \n",
       "129                NaN        NaN              7        201         115   \n",
       "...                ...        ...            ...        ...         ...   \n",
       "152054             NaN        NaN            152          1           4   \n",
       "152055             NaN        NaN            154         -1           3   \n",
       "152056         run out  KH Pandya            155         -2           2   \n",
       "152057             NaN        NaN            157         -4           1   \n",
       "152058             lbw        NaN            157         -4           0   \n",
       "\n",
       "        wickets_remaining   crr  \n",
       "125                    10  6.00  \n",
       "126                    10  3.00  \n",
       "127                    10  2.00  \n",
       "128                    10  4.50  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...               ...  ...          ...              ...             ...   \n",
       "152054      RA Jadeja  ...            1                0             NaN   \n",
       "152055      SR Watson  ...            2                0             NaN   \n",
       "152056      SR Watson  ...            1                1         run out   \n",
       "152057      SN Thakur  ...            2                0             NaN   \n",
       "152058      SN Thakur  ...            0                1             lbw   \n",
       "\n",
       "          fielder  current_Score  runs_left  balls_left  wickets_remaining  \\\n",
       "125           NaN              1        207         119                 10   \n",
       "126           NaN              1        207         118                 10   \n",
       "127           NaN              1        207         117                 10   \n",
       "128           NaN              3        205         116                 10   \n",
       "129           NaN              7        201         115                 10   \n",
       "...           ...            ...        ...         ...                ...   \n",
       "152054        NaN            152          1           4                  5   \n",
       "152055        NaN            154         -1           3                  5   \n",
       "152056  KH Pandya            155         -2           2                  4   \n",
       "152057        NaN            157         -4           1                  4   \n",
       "152058        NaN            157         -4           0                  3   \n",
       "\n",
       "         crr    rrr  \n",
       "125     6.00  10.44  \n",
       "126     3.00  10.53  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...               ...  ...              ...            ...        ...   \n",
       "152054      RA Jadeja  ...                0            NaN        NaN   \n",
       "152055      SR Watson  ...                0            NaN        NaN   \n",
       "152056      SR Watson  ...                1        run out  KH Pandya   \n",
       "152057      SN Thakur  ...                0            NaN        NaN   \n",
       "152058      SN Thakur  ...                1            lbw        NaN   \n",
       "\n",
       "        current_Score  runs_left  balls_left  wickets_remaining   crr    rrr  \\\n",
       "125                 1        207         119                 10  6.00  10.44   \n",
       "126                 1        207         118                 10  3.00  10.53   \n",
       "127                 1        207         117                 10  2.00  10.62   \n",
       "128                 3        205         116                 10  4.50  10.60   \n",
       "129                 7        201         115                 10  8.40  10.49   \n",
       "...               ...        ...         ...                ...   ...    ...   \n",
       "152054            152          1           4                  5  7.86   1.50   \n",
       "152055            154         -1           3                  5  7.90  -2.00   \n",
       "152056            155         -2           2                  4  7.88  -6.00   \n",
       "152057            157         -4           1                  4  7.92 -24.00   \n",
       "152058            157         -4           0                  3  7.85   -inf   \n",
       "\n",
       "        results  \n",
       "125           0  \n",
       "126           0  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "...                             ...                  ...        ...   \n",
       "152054          Chennai Super Kings       Mumbai Indians  Hyderabad   \n",
       "152055          Chennai Super Kings       Mumbai Indians  Hyderabad   \n",
       "152056          Chennai Super Kings       Mumbai Indians  Hyderabad   \n",
       "152057          Chennai Super Kings       Mumbai Indians  Hyderabad   \n",
       "152058          Chennai Super Kings       Mumbai Indians  Hyderabad   \n",
       "\n",
       "        runs_left  balls_left  wickets_remaining  total_runs_x   crr    rrr  \\\n",
       "125           207         119                 10           208  6.00  10.44   \n",
       "126           207         118                 10           208  3.00  10.53   \n",
       "127           207         117                 10           208  2.00  10.62   \n",
       "128           205         116                 10           208  4.50  10.60   \n",
       "129           201         115                 10           208  8.40  10.49   \n",
       "...           ...         ...                ...           ...   ...    ...   \n",
       "152054          1           4                  5           153  7.86   1.50   \n",
       "152055         -1           3                  5           153  7.90  -2.00   \n",
       "152056         -2           2                  4           153  7.88  -6.00   \n",
       "152057         -4           1                  4           153  7.92 -24.00   \n",
       "152058         -4           0                  3           153  7.85   -inf   \n",
       "\n",
       "        results  \n",
       "125           0  \n",
       "126           0  \n",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>54174 rows × 9 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "                 batting_team                 bowling_team        city  \\\n",
       "66783          Mumbai Indians          Sunrisers Hyderabad      Mumbai   \n",
       "140867         Delhi Capitals              Kings XI Punjab      Mohali   \n",
       "129728         Mumbai Indians          Chennai Super Kings        Pune   \n",
       "86074         Kings XI Punjab  Royal Challengers Bangalore  Chandigarh   \n",
       "36213   Kolkata Knight Riders          Chennai Super Kings     Kolkata   \n",
       "...                       ...                          ...         ...   \n",
       "11593   Kolkata Knight Riders             Rajasthan Royals      Jaipur   \n",
       "50908   Kolkata Knight Riders             Rajasthan Royals      Jaipur   \n",
       "131198  Kolkata Knight Riders          Chennai Super Kings     Kolkata   \n",
       "30277     Sunrisers Hyderabad               Delhi Capitals      Durban   \n",
       "42464         Kings XI Punjab        Kolkata Knight Riders     Kolkata   \n",
       "\n",
       "        runs_left  balls_left  wickets_remaining  total_runs_x    crr    rrr  \n",
       "66783          38          50                  7           101   5.40   4.56  \n",
       "140867         74          50                  7           176   8.74   8.88  \n",
       "129728        171         115                 10           177   7.20   8.92  \n",
       "86074          62          32                  6           191   8.80  11.62  \n",
       "36213          95          55                  4           165   6.46  10.36  \n",
       "...           ...         ...                ...           ...    ...    ...  \n",
       "11593         188         113                 10           197   7.71   9.98  \n",
       "50908          52          42                  9           160   8.31   7.43  \n",
       "131198         98          66                  7           185   9.67   8.91  \n",
       "30277         139          98                  9           174   9.55   8.51  \n",
       "42464         171         102                 10           201  10.00  10.06  \n",
       "\n",
       "[54174 rows x 9 columns]"
      ]
     },
     "execution_count": 38,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  </tbody>\n",
       "</table>\n",
       "<p>18059 rows × 9 columns</p>\n",
       "</div>"
      ],
      "text/plain": [
       "                       batting_team                 bowling_team        city  \\\n",
       "56826                Delhi Capitals          Chennai Super Kings     Chennai   \n",
       "134547             Rajasthan Royals               Mumbai Indians      Mumbai   \n",
       "21991   Royal Challengers Bangalore          Sunrisers Hyderabad   Cape Town   \n",
       "10484               Kings XI Punjab               Delhi Capitals  Chandigarh   \n",
       "144933          Sunrisers Hyderabad               Delhi Capitals   Hyderabad   \n",
       "...                             ...                          ...         ...   \n",
       "52234           Chennai Super Kings               Mumbai Indians      Mumbai   \n",
       "82050         Kolkata Knight Riders             Rajasthan Royals     Kolkata   \n",
       "65346              Rajasthan Royals  Royal Challengers Bangalore      Jaipur   \n",
       "70837                Delhi Capitals              Kings XI Punjab       Delhi   \n",
       "44434           Sunrisers Hyderabad          Chennai Super Kings      Nagpur   \n",
       "\n",
       "        runs_left  balls_left  wickets_remaining  total_runs_x    crr    rrr  \n",
       "56826         113          62                  8           177   6.62  10.94  \n",
       "134547        160         113                  9           178  15.43   8.50  \n",
       "21991         183         116                  9           185   3.00   9.47  \n",
       "10484           1           6                  4           159   8.32   1.00  \n",
       "144933        129          91                 10           165   7.45   8.51  \n",
       "...           ...         ...                ...           ...    ...    ...  \n",
       "52234         160         115                 10           165   6.00   8.35  \n",
       "82050          20          33                  8           133   7.79   3.64  \n",
       "65346          55           6                  4           190   7.11  55.00  \n",
       "70837         102          93                  8           137   7.78   6.58  \n",
       "44434         102          84                  8           139   6.17   7.29  \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array(['Mumbai', 'Port Elizabeth', 'Kolkata', 'Chennai', 'Delhi',\n",
       "       'Bangalore', 'Kimberley', 'Mohali', 'Johannesburg', 'Bengaluru',\n",
       "       'Jaipur', 'Hyderabad', 'Dharamsala', 'Cuttack', 'Ranchi', 'Durban',\n",
       "       'Indore', 'Ahmedabad', 'Cape Town', 'Centurion', 'Chandigarh',\n",
       "       'Nagpur', 'Pune', 'Abu Dhabi', 'Visakhapatnam', 'Sharjah',\n",
       "       'East London', 'Raipur', 'Bloemfontein'], dtype=object)"
      ]
     },
     "execution_count": 47,
     "metadata": {},
